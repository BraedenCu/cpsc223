...
*/
skills_list skills_list_append(skills_list *skills, char *skill);
...
*/
int skills_list_remove_last(skills_list *skills);
...
*/
void skills_list_destroy(skills_list *skills);
...
*/
int skills_list_length(skills_list *skills);
...
*/
char *skills_list_get(skills_list *skills, int index);
...
*/
int skills_list_index_of(skills_list *skills, char *skill);
